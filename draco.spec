...
Version  : 1.5.7
Release  : 3
URL      : https://github.com/google/draco/archive/1.5.7/draco-1.5.7.tar.gz
Source0  : https://github.com/google/draco/archive/1.5.7/draco-1.5.7.tar.gz
...
%prep
%setup -q -n draco-1.5.7
cd %{_builddir}/draco-1.5.7
pushd ..
cp -a draco-1.5.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719960091
mkdir -p clr-build
pushd clr-build
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/draco_decoder-1.5.7
/V3/usr/bin/draco_encoder-1.5.7
/usr/bin/draco_decoder
/usr/bin/draco_decoder-1.5.7
/usr/bin/draco_encoder
/usr/bin/draco_encoder-1.5.7
...
/usr/include/draco/metadata/property_attribute.h
/usr/include/draco/metadata/property_table.h
/usr/include/draco/metadata/structural_metadata.h
/usr/include/draco/metadata/structural_metadata_schema.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdraco.so.9.0.0
/usr/lib64/libdraco.so.9
/usr/lib64/libdraco.so.9.0.0
